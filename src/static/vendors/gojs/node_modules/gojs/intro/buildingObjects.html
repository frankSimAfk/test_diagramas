...
<!-- Copyright 1998-2023 by Northwoods Software Corporation. -->    <title> GoJS Building GraphObjects -- Northwoods Software </title>
...
<pre class="lang-js" id="commented" style="display:none"><code>
  ...
  var itemTempl =
    $(go.Panel, "TableRow",
      new go.Binding("portId", "name", n => n + "ITEMPANEL"),
      new go.Binding("background", "row", i => (i === 2) ? "lightgreen" : "transparent").ofObject(),
      $(go.Shape,
        new go.Binding("portId", "name", n => n + "SHAPE"),
      ...
      $(go.TextBlock,
        ...
        new go.Binding("portId", "name", n => n + "TEXTBLOCK"))
    );
