...
<!-- Copyright 1998-2023 by Northwoods Software Corporation. -->    <title> Get Started with GoJS </title>
...
<script>
const myDiagram = new go.Diagram("myDiagramDiv3",
  { // enable Ctrl-Z to undo and Ctrl-Y to redo
    "undoManager.isEnabled": true
  });
...
<script>
const myDiagram = new go.Diagram("myDiagramDiv4",
  {
    "undoManager.isEnabled": true
  });
...
<script>
const myDiagram = new go.Diagram("myDiagramDiv5",
  {
    "undoManager.isEnabled": true,
    layout: new go.TreeLayout({ angle: 90, layerSpacing: 35 })
  });
...
<script>
const myDiagram = new go.Diagram("myDiagramDiv6",
  {
    "undoManager.isEnabled": true,
    layout: new go.TreeLayout({ angle: 90, layerSpacing: 35 })
  });
