...
<!-- Copyright 1998-2023 by Northwoods Software Corporation. -->    <title>Download GoJS</title>
...
<p>
  ...
  We encourage you to <a href="https://nwoods.com/register.html" target="_blank">register</a> if you discover you need
  technical support during your evaluation.
</p>
<p>
...
<p>
  We also maintain a <a href="https://github.com/NorthwoodsSoftware/GoJS">GitHub Repository</a> of all libraries,
  documentation, samples, and extensions.
  This allows you to <a href="https://github.com/NorthwoodsSoftware/GoJS/search?q=setDataProperty&amp;type=Code">search
    through documentation and code online</a>.
</p>
<p>
  The contents of both the ZIP file and the GitHub repository are exactly what you find at the <a href="index.html">GoJS
    web site</a>.
  Having everything downloaded to your development machine allows you to easily search the JavaScript code and to modify
  the samples for experimentation.
</p>
<p>
  You can also download <b>GoJS</b> via <a href="https://www.npmjs.com/package/gojs" target="_blank">Node package
    manager (npm)</a>:
...
<ul>
  <li>
    ...
    <ul>
      ...
      <li>
        Most recent 2.2: <code>"https://unpkg.com/gojs@2.1/release/go.js"</code>
      </li>
    </ul>
  </li>
  <li>
    ...
    <ul>
      ...
      <li>
        Most recent 2.2: <code>"https://cdn.jsdelivr.net/npm/gojs@2.1/release/go.js"</code>
      </li>
    </ul>
  </li>
  <!--<li>
...
<ul>
  <li>"watch" the <a href="https://github.com/NorthwoodsSoftware/GoJS" target="_blank">GoJS GitHub repository</a> for
    new releases</li>
  <li>read the <a href="https://www.npmjs.com/package/gojs" target="_blank">GoJS npm package</a> page, or write a "hook"
    for it</li>
  <li>follow us on Twitter: <a href="https://twitter.com/northwoodsgo" target="_blank">@NorthwoodsGo</a></li>
  <li>
    read the GoJS Change Log page (<a href="https://gojs.net/latest/changelog.html" target="_blank">latest</a><span
      id="thisversion"></span>)</a>
  </li>
  <li>read or follow the <a href="https://forum.nwoods.com/c/gojs" target="_blank">Northwoods GoJS Forum</a></li>
</ul>
<p>
  When updating or upgrading to a newer version, please read the <a href="changelog.html" target="_blank">Change
    Log</a>.
...
<script type="text/javascript">
  document.getElementById('ziplink').addEventListener('click', () => {
    ga('send', 'event', 'button', 'click', 'download-zip');
  });

  document.addEventListener('DOMContentLoaded', () => {
    if (!go || !go.version) return;
    if (location.href.indexOf('latest') !== -1) return;
    const span = document.getElementById('thisversion');
    span.innerHTML = `, <a href="./changelog.html" target="_blank">this version: ${go.version}</a>`
  })
